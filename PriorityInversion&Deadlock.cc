#define PRIORITY_INVERSION_SCENARIO
//#define DEADLOCK_SCENARIO


#ifdef DEADLOCK_SCENARIO
...
class Ctimer
{
	...
	public:
		Ctimer(int sec,int nanosec); // create the timer and initiate it
		~Ctimer();
		void wait(); //
};

Ctimer::Ctimer(int sec,int nanosec)
{
...
void Ctimer::wait(){  // Wait for timer tick
}
...
#ifdef PRIORITY_INVERSION_SCENARIO
//=======================PRIORITY INVERSION==================================
//===========================================================================
//===========================================================================
//===========================================================================
